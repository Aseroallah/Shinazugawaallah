...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        <label>Name</label>
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "Shinazugawallah"}" placeholder="Nickname" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
        <label>Room</label>
      ...
      <div class="field" id="botamount">
        ...
        <div class="ui large labeled input"><input type="number" value="${params.get('amount') || "31"}" min="1" max="100"></div>
      </div>
    </div>
...
<div class="ui fluid selection profil bot-image dropdown" tabaindex="0">
  ...
  <div data-value="0" class="item active selected">
        <img class="ui avatar image" src="https://media.discordapp.net/attachments/1114886341264670814/1123281217375191070/sanemi_sama.jpg?width=427&height=427="1" class="item">
  ...
  <div class="inline fields">
    ...
    <a href="https://heyyoelchavo.github.io/heyyoelchavo.github.io/" target="_blank" class="ui right floated
...
<a href="https://heyyyoelchavo.github.io/heyyoelchavo.github.io/" class="ui right floated
    ...
    socket.addEventListener('message', (event) => {
      ...
      switch (data[0]) {
        case 5: {
          ...
          if (params.get('private-mode') !== "true") { socket.send(`42[11,"${playerId}"," Shinazugawallah"]`); }
